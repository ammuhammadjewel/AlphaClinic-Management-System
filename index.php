...
<?php
include_once('acms/user/php_user/include/config.php');
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                ...
                <img src="Alpha.PNG" width="100" height="100" alt="logo picture">
                <div  class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font: size 45px; margin-top: 1% !important;">
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="acms/user/php_user/user-login.php" target="_blank"> 
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="acms/doctor/php_doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="acms/admin/php_admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <h2>Our Services</h2>
                <p>We Have The Experts To Safeguard Your Life</p>
            </div>
     ...
     <div id="motto" class="motto">    
           <div class="container">
              <div class="inner-title">
                ...
                <h2>Why Do You Need Health Chek Ups?</h2>
                <p>We Stand Together For You</p>
            </div>
              <div class="row">

     <iframe width="385" height="300"
src="https://www.youtube.com/embed/pc1jlelzmPY?autoplay=1&mute=1">
</iframe> &nbsp &nbsp

<iframe width="330" height="300"
src="https://www.youtube.com/embed/I12PMiX5h3E?autoplay=1&mute=1">
</iframe> &nbsp &nbsp
       
     <iframe width="385" height="300"
src="https://www.youtube.com/embed/U8GPBaV0jOM?autoplay=1&mute=1">
</iframe>
...
?>
    ...
    <div class="copy">
            <div class="container">
            © 2023 Alpha Clinic. All Rights Reserved. &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    Developed by Team Alpha Boys 
